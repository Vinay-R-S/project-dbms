            ...
            <div className="w-full h-full flex justify-center align-center">
                <div className="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                    ...
                    <form className="mt-8 space-y-6" action="#" mehtod="POST">
                        <div>
                            {/* Name */}
                            <input type="text" name="username" id="name" className="mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your name" required />
                            ...
                            {/* Post [or] Role */}
                            <input type="text" name="role" id="role" className="mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your role" required />
                        ...
                        <div className="flex flex-col justify-center align-center">
                            ...
                            <div className="flex justify-center align-center text-sm font-medium text-gray-900 dark:text-white">
                                ...
                                <a className="text-blue-600 hover:underline dark:text-blue-500">Log in</a>
                            </div>
                        </div>
                    </form>
                </div>
